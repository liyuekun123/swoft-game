...
var SubCmd = {
    ...
    CHAT_MSG_REQ: 213,
    CHAT_MSG_RESP: 214,
    JOIN_ROOM_REQ: 215,          //[client]加入房间请求
    JOIN_ROOM_RESP: 216,         //[server]加入房间请求
    EXIT_ROOM_REQ: 217,         //[client]退出房间请求
    EXIT_ROOM_RESP: 218,         //[server]退出房间请求
    ROOM_NOTIFY_REQ: 219,        //[client]房间通信
    ROOM_NOTIFY_RESP: 220,       //[server]房间通信
}
